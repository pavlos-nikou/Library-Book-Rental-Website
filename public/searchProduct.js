        ...
        if (loading === false) {
            ...
            if (displayItems.childElementCount >= 10) {
                ...
                if (currentUrl[5].slice(0, 1) == "s") {
                    ...
                    url = `/UnderConstruction/searchproducts/s/${searchTerm}/${displayItems.childElementCount - 1}`
                }
                if (currentUrl[5] == "g") {

                    url = `/UnderConstruction/searchproducts/g/${currentUrl[6].slice(0, -1)}/${displayItems.childElementCount - 1}`
                }
                // console.log(url)
                fetch(url)
                    .then(response => {
